  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        height: "500px",
        borderRadius: "50%",
        background: "radial-gradient(circle at 30% 30%, rgba(232,184,64,0.15), transparent 70%)",
        filter: "blur(40px)",
      ...
      <div style={{
        ...
        height: "400px",
        borderRadius: "50%",
        background: "radial-gradient(circle at 70% 70%, rgba(100,150,255,0.12), transparent 70%)",
        filter: "blur(50px)",
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h1 style={{
              ...
              <span style={{
                display: "block",
                background: "linear-gradient(135deg, #fff 0%, #f0ead0 50%, #e8b840 100%)",
              ...
              <span style={{
                ...
                textShadow: `0 0 ${20 + glowValue * 20}px rgba(232,184,64,${0.3 + glowValue * 0.3})`,
                marginTop: "-15px"
              }}>
                PERFECTION
              </span>
            ...
            <p style={{
              ...
              <span style={{
                ...
                width: "2px",
                height: "100%",
                background: "linear-gradient(to bottom, transparent, #e8b840, transparent)"
              }} />
              Experience the pinnacle of automotive artistry. We don't just detail cars — 
              we orchestrate masterpieces that transcend ordinary expectations.
            </p>
            ...
            <div style={{
              ...
              <a 
                ...
                style={{
                  ...
                  boxShadow: `0 10px 30px -5px rgba(232,184,64,${0.3 + glowValue * 0.3})`
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = "translateY(-3px) scale(1.02)";
                  e.currentTarget.style.boxShadow = `0 20px 40px -5px rgba(232,184,64,${0.5 + glowValue * 0.3})`;
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = "translateY(0) scale(1)";
                  e.currentTarget.style.boxShadow = `0 10px 30px -5px rgba(232,184,64,${0.3 + glowValue * 0.3})`;
                }}
              >
              ...
              <a 
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = "0 10px 20px -5px rgba(232,184,64,0.3)";
                }}
                onMouseLeave={(e) => {
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                filter: `drop-shadow(0 0 ${30 + glowValue * 30}px rgba(232,184,64,${0.3 + glowValue * 0.3}))`,
                transition: "filter 0.1s ease"
              }}>
                <RealisticCar scale={1} headlightsOn={true} wheelAngle={mousePosition.x * 10} />
              </div>
              ...
              {[...Array(20)].map((_, i) => (
                <div
                  ...
                  style={{
                    position: "absolute",
                    top: `${50 + Math.sin(i * 0.5 + glowIntensity) * 40}%`,
                    left: `${50 + Math.cos(i * 0.3 + glowIntensity) * 40}%`,
                    width: "4px",
                    height: "4px",
                    borderRadius: "50%",
                    background: `rgba(232,184,64,${0.1 + Math.sin(i + glowIntensity) * 0.1})`,
                    transform: "translate(-50%, -50%)",
